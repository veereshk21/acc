...
/*
export const cpcInterceptPromptExploreAPI = (url, data) => axios.post(url, data);

export const onCpcPromptExploreTVP = (url, data = {}) => (dispatch) => {
  dispatch(asyncFetch());

  cpcInterceptPromptExploreAPI(url, data).then((resp) => {
