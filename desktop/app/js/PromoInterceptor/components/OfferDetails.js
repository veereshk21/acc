...
const OfferDetails = (props) => {
  const { data, showOverlay, cqContent, eligibleModalDetails } = props;
  return (
          ...
          {data.promoMessage
            && (
              <div className="pad24 onlyTopPad">
                <h2 className="margin24 onlyBottomMargin fontTitleSmall" dangerouslySetInnerHTML={{ __html: data.promoMessage.title }} />
                <h3 className="margin12 onlyBottomMargin fontSubTitle" dangerouslySetInnerHTML={{ __html: data.promoMessage.subtitle }} />
