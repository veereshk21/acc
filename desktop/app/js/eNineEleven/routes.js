  ...
  return [
    {
      ...
      component: Loadable.Map({
        loading: Loader,
        loader: {
          page: () => import('./containers/AddressFormContainer'),
        ...
        render(loaded, props) {
          ...
          injectReducer('showWarningMessage', loaded.reducer.showWarningMessage);
          injectReducer('updateEmergencyContactInfo', loaded.reducer.updateEmergencyContactInfo);
    ...
    },
    {
      ...
      component: Loadable.Map({
        loading: Loader,
        loader: {
          page: () => import('./containers/AddressOptionsContainer'),
          reducer: () => import('./reducer'),
        },
        render(loaded, props) {
          const Component = loaded.page.default;
          injectReducer('asyncCallStatus', loaded.reducer.asyncCallStatus);
          injectReducer('addressInfoDetails', loaded.reducer.addressInfoDetails);
          return <Component {...props} />;
        },
      }),
    },
