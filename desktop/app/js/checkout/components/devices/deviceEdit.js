...
class DeviceEdit extends Component {
  ...
  validateNewNumber = () => {
    ...
    if (this.getFormValue('npnxx') === 'new' && !this.getFormValue('newNumber')) {
      isDisabled = true;
    }
    return isDisabled;
  }
  render() {
    ...
    return (
      <div>
          ...
          <Col xs={9} lg={10} className="noPad">
                ...
                <Col xs={6}>
                  ...
                  <div className="margin6 noSideMargin">
                    ...
                    <RadioButton
                      ...
                      analyticstrack="device-transferNumber-radio"
                    >
                      <div>
                    ...
                    <RadioButton
                      ...
                      containerClassName="pad6 noSidePad"
                      labelClassName="verticalCenter pad12 onlyLeftPad radioLabel"
                      analyticstrack="device-newNumber-radio"
                    >
                    ...
                    {((npaNxxdetails && npaNxxdetails.mtns && npaNxxdetails.mtns.length > 0) || device.npaNxxnumber) &&
                      <RadioButton
                        ...
                        containerClassName="pad6 noSidePad"
                        labelClassName="verticalCenter pad12 onlyLeftPad radioLabel"
                        analyticstrack="device-npaNxxnumber-radio"
                      >
            ...
            <div className={((device.flow === 'AAL' || device.flow === 'NSO') && this.getFormValue('npnxx') !== 'transfer') ? '' : 'displayNone'}>
              <Checkbox
                ...
                analyticstrack="device-sameNumber-checkbox"
              >
        ...
        <div className={`width100 pad24 clearfix ${index > 0 ? 'onlyTopPad' : 'noSidePad'}`}>
          <button
            className="primary button large"
            type="submit"
            disabled={!valid || submitting || this.serviceAddressHasErrors() || this.validateNewNumber()}
            analyticstrack="device-deviceInfo-update-CTA"
            onClick={
              handleSubmit((data) => {
          ...
          {!this.props.required &&
            <button
              ...
              analyticstrack="device-deviceInfo-cancel-CTA"
            >
