...
class ServiceAddressEdit extends Component {
  ...
  render() {
    const {
      cqContent, sameAsShippingAddress, states, index, valid, submitting, handleSubmit, onClickCancel,
    } = this.props;

    return (
      <div>
        <div className="pad12 onlyBottomPad">
          <div>
            <h3 className="displayInlineBlock fontSize_5">
          ...
          <div className={sameAsShippingAddress ? 'margin18 onlyTopMargin' : ''}>
            <Checkbox
              className="checkbox"
              ...
              component="input"
              type="checkbox"
              labelClass="displayInlineBlock verticalCenter leftAlign pad12 onlyLeftPad checkboxLabel"
