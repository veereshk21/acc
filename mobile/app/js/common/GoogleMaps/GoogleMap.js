/* eslint-disable no-undef,react/no-find-dom-node,react/prop-types,react/no-string-refs,no-unused-expressions,no-nested-ternary, no-restricted-globals */
/**
...
// import PinLocation from '../../../images/pinned_location.png';
class GoogleMap extends Component {
  constructor(props) {
    ...
    if (this.props.center === undefined && this.props.defaultCenter === undefined) {
      console.warn('GoogleMap: center or defaultCenter' +
                'property must be defined');
    }

    if (this.props.zoom === undefined && this.props.defaultZoom === undefined) {
      console.warn('GoogleMap: zoom or defaultZoom' +
                'property must be defined');
    }
  }
    ...
    this.googleMapLoader(bootstrapURLKeys).then((maps) => {
      ...
      if (this.refs.google_map_dom !== null && this.refs.google_map_dom !== undefined) {
        ...
        const pinnedLocation = {
          url: '/reactive/shop/mobile/build/images/pinned_location.png',
