...
class SessionOutModal extends Component {
  ...
  onExtendSessionHandler() {
    ...
    this.props.keepSessionAlive(this.isLoggedIn() ? this.props.continueSessionURL : this.props.guestContinueSessionURL).then((res) => {//eslint-disable-line
      this.setState({ showModal: false });
      clearInterval(this.interval);
      this.startTimer(this.sessionTime * 60);
    ...
    return (
      <div>
        ...
        <Modal
          ...
          showCloseX={false}
        >
          {this.state.sessionTimedOut === false && <div className="margin0 noPad">
            <Row>
              <Col xs={12} sm={12} lg={12}>
                <h1 className="fontSize_5-1 height160 lineHeight18">
                ...
                <div className="margin6 onlyTopMargin positionAbsolute top50-calc-30px width100-calc-40 border_00 onlyTopBorder pad6 onlyTopPad">
                  {isLoggedIn ?
                    <div>
                    ...
                    :
                    <p>You will lose the items in your cart if your session expires.</p>
                  }
                </div>
                <button className="button primary margin24 onlyTopMargin positionAbsolute bottom20 width100-calc-40" onClick={this.onExtendSessionHandler}>
          ...
          {this.state.sessionTimedOut === true && <div className="margin0 noPad">
            <Row>
              <Col xs={12} sm={12} lg={12}>
                <h1 className="fontSize_5-1 height160 lineHeight18">
                ...
                <button className="button primary  margin24 onlyTopMargin positionAbsolute bottom20 width100-calc-40" onClick={this.onClickLoginHandler}>
...
const mapDispatchToProps = (dispatch) => bindActionCreators({
  keepSessionAlive, extendSession, extendSessionSucess, extendSessionFalied,
}, dispatch);
