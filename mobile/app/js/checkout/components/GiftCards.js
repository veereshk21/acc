        ...
        <Row className="noSideMargin pad24">
          <Col xs={12}>
            ...
            {cqContent.label.OD_CHECKOUT_GIFT_CARD_SUBTITLE &&
              <p dangerouslySetInnerHTML={{ __html: cqContent.label.OD_CHECKOUT_GIFT_CARD_SUBTITLE }} />
            }
        ...
        <Row className="textAlignCenter">
          <Col xs={12}>
            <div className="margin18">
              ...
              <a role="button" className="link" onClick={this.showMoreOnClick} analyticstrack="add-giftcard">
            ...
            <button
              ...
              analyticstrack="submit-giftcard"
            >
