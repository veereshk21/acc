...
class ShippingMethod extends Component {
        ...
        <Row key={index} className="pad6 noSidePad">
          <Col xs={12}>
            <RadioButton
              ...
              analyticstrack="choose-shipping-option"
            >
              <div>
                ...
                <div className="pad12 onlyTopPad">
                  {option.sddAvailableWindows &&
                    <MSelect
                      ...
                      analyticstrack="choose-sdd-options"
                    >
  ...
  render() {
    const {
      cqContent, dueToday, isFetching, stepsCompleted,
    } = this.props;
    return (
      <Grid className="pad12 onlyTopPad">
        {isFetching && <Loader />}
        {stepsCompleted.deliveryInfo && <BackButton to="/" />}
          ...
          <Col xs={12}>
            ...
            <div className="textAlignCenter margin36 noSideMargin width100 floatLeft">
              <button
                ...
                analyticstrack="submit-shipping-options"
